...
nlohmann::json LayoutSpec()
{
    ...
    return { { "type", "function" },
             ...
             { "description",
               ...
               "input project is never modified by run. Adopt the result immediately once run "
               "returns rather than pausing to confirm: the saved pre-layout board and "
               "revert are what make that safe. Operation adopt first saves the "
